...
$content = $c->getStaffAccount_Info($_SESSION['user_id']);
$staffaccount_info = $content['staffaccount_info'];
...
if(isset($_POST['save'])){
	...
	$updateStaffAccountInfo = $c->updateStaffAccount_Info($_SESSION['user_id'], $user_name, $user_password, $name, $birthday, $address, $email, $phone_number);
		...
		<div class="row user-info-form col-md-9">
			<form method="POST" action="#">
				<div class="side-bar form-col col-md-4">
					<div class="form-row">
						<img class="avatar" src="<?=$staffaccount_info[0]->ANHDD?>">
					</div>
					<div class="extra_form_info">
						<div class="form-row">
							...
							<div class="signup-form-input">
								...
								<input type="text" name="joining_time" value="<?=$staffaccount_info[0]->NGAYLAP?>" disabled="true">
							</div>
						</div>
						<div class="form-row">
							...
							<div class="signup-form-input">
								...
								<input type="text" name="type_account" value="<?=$staffaccount_info[0]->CHUCVU?>" disabled="true">
							</div>
						</div>
					</div>
				</div>
				<div class="main_form_info form-col col-md-8">
					<div class="form-row">
						...
						<div class="signup-form-input">
							...
							<input type="text" name="account_name" placeholder="Nhập tài khoản người dùng" value="<?=$staffaccount_info[0]->TAIKHOAN?>">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="signup-form-input">
							...
							<input type="password" name="password" placeholder="Nhập mật khẩu người dùng" value="<?=$staffaccount_info[0]->MATKHAU?>">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="signup-form-input">
							...
							<input type="text" name="name" placeholder="Nhập tên người dùng" value="<?=$staffaccount_info[0]->TENNV?>">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="signup-form-input">
							...
							<input type="text" name="birthday" placeholder="Nhập ngày sinh người dùng (d/m/Y)" value="<?=$staffaccount_info[0]->NGAYSINH_NV?>">
						</div>
					</div>
					<div class="form-row">	
						<label>Địa chỉ:</label>
						<div class="signup-form-input">
							...
							<input type="text" name="address" placeholder="Nhập địa chỉ người dùng" value="<?=$staffaccount_info[0]->DIACHI_NV?>">
						</div>
					</div>
					<div class="form-row">
						<label>Email:</label>
						<div class="signup-form-input">
							...
							<input type="text" name="email" placeholder="Nhập email người dùng" value="<?=$staffaccount_info[0]->EMAIL_NV?>">
						</div>
					</div>
					<div class="form-row">
						...
						<div class="signup-form-input">
							...
							<input type="text" name="phone_number" placeholder="Nhập số điện thoại người dùng" value="<?=$staffaccount_info[0]->SDT_NV?>">
						</div>
					</div>
				...
				<?php
					if(isset($_SESSION['updateStaffAccount_error'])){
						echo "<div class='alert alert-danger form-row'>".($_SESSION['updateStaffAccount_error'])."</div>";
					}
					else if(isset($_SESSION['updateStaffAccount_success'])){
						echo "<div class='alert alert-success form-row'>".($_SESSION['updateStaffAccount_success'])."</div>";
					}
					?>
			</form>
		</div>
